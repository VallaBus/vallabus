...
const statsCards = [
    {
        ...
        title: "Periodo",
        value: "28 días",
        subtitle: "1 al 28 de febrero 2025"
    },
    {
        icon: 'file-bar-chart',
        title: "Registros",
...
function shareReport() {
    ...
    if (typeof _paq !== 'undefined') {
        _paq.push(['trackEvent', 'Compartir', 'Informe', 'AUVASA febrero 2025']);
    }

    if (navigator.share) {
        navigator.share({
            title: 'Informe sobre calidad del servicio de AUVASA - febrero 2025',
            text: text,
            url: url.toString()
        })
